...
flags.DEFINE_string('ckpt_path', '20200725', 'ckpt_path')
...
value_path_npy1 = './20200704'+'/rankrate_ave'+FLAGS.rank_rate_ave[0]+'_'+FLAGS.rank_rate_ave[2]+'_rankrate_single'+FLAGS.rank_rate_single[0:]
value_path_npy2 = './20200725'+'/rankrate_ave'+FLAGS.rank_rate_ave[0]+'_'+FLAGS.rank_rate_ave[2]+'_rankrate_single'+FLAGS.rank_rate_single[0:]

value_dict_even = np.load(value_path_npy1+'/iter_even'+FLAGS.iter+'.npy', allow_pickle=True).item()
value_dict_odd = np.load(value_path_npy2+'/iter_odd'+FLAGS.iter+'.npy', allow_pickle=True).item()
