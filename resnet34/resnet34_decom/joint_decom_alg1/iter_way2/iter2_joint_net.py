...
flags.DEFINE_string('ckpt_path', '20200720_all_train_set_fine_tune', 'rank_rate of each block1 conv2')
...
val_images, val_labels = image_processing.inputs(imagenet_data_val, batch_size=250, num_preprocess_threads=4)
...
value_dict = np.load(value_path_npy+'/iter'+FLAGS.iter+'.npy', allow_pickle=True).item()
